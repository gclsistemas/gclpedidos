...
export class ListPage {
  ...
  constructor(private base64: Base64, private currencyPipe: CurrencyPipe, public navCtrl: NavController, public navParams: NavParams, private alertCtrl: AlertController,
  ...
  private createPdf(index) {
    ...
    let total: number = 0;
    let bodyTable = [[{text: '#', alignment: 'center'}, {text: 'Descripción', alignment: 'center'}, {text: 'Precio', alignment: 'center'}, {text: 'Importe', alignment: 'center'}]];
    for (let idx = 0; idx < this.pedidos[index].orden_venta_detalle.length; idx++) {
      ...
      bodyTable[bodyTable.length] = [detalle.cantidad, detalle.producto, {text: detalle.precio, alignment: 'right'}, {text: detalle.importe, alignment: 'right'}];
